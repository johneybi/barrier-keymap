...
void KeyRemapDialog::addMacPreset()
{
    ...
    addRow({screen, QStringLiteral("right_alt"), QStringLiteral("F19"), QStringLiteral("right_super")});
    addRow({screen, QStringLiteral("hangul"), QStringLiteral("F19"), QStringLiteral("right_super")});
